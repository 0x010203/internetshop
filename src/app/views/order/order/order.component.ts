...
export class OrderComponent implements OnInit {
  ...
  createOrder() {
    if (
      ...
      this.orderService
        .createOrder(
          //плохой способ, т.к. подсовываем сами не знаем что
          //   {
          //   deliveryType: this.deliveryType,
        ...
        .subscribe({
          ...
          error: (errorReasonse: HttpErrorResponse) => {
            if (errorReasonse.error && errorReasonse.error.message) {
              this._snackBar.open(errorReasonse.error.message);
            } else {
